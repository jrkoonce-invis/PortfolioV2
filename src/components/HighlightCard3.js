...
const HighlightCard3 = ({ color, title, desc, image1, image2, image3 }) => {
    return (
        <div className="flex flex-row gap-[20px]">
            ...
            <div>
                {image3 &&
                    <Image className="hover:scale-[1.05] duration-200 mt-[320px] rounded-[50px]" src={`/assets/${image3}`} alt="Image Unavailable" style={{objectFit: "contain"}} width={300} height={300} />
                }
            </div>
        </div>
    );
