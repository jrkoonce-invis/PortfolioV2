...
const ProjectCard = ({ color, title, desc, date, image, link }) => {
    return (
        <div className="flex flex-row gap-[20px] pointer-cursor">
            <a href={link}>
                <div className={`duration-200 hover:shadow-lg hover:border-[3] hover:scale-[1.05] cursor-pointer border-textcolor w-[600px] h-fit pt-[40px] pb-[40px] bg-${color} border-2 border-text rounded-[50px] flex flex-col gap-[10px] justify-center`}>
                    <div className="w-[520px] ml-auto mr-auto flex flex-row gap-[10px] items-center">
